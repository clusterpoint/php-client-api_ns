...
echo "Start!\n";
$directory = '../';
$outputDirectory = '../../php-client-api/';
$fileArr = makeFilesArray($directory, '/.+\.php/');
stripNamespace($fileArr, $directory, $outputDirectory);

$directory = '../internals/';
$outputDirectory = '../../php-client-api/internals/';
$fileArr = makeFilesArray($directory, '/.+\.php/');
stripNamespace($fileArr, $directory, $outputDirectory);
echo "End!\n";

function stripNamespace($fileArr, $directory, $outputDirectory)
{
  var_dump($fileArr);
